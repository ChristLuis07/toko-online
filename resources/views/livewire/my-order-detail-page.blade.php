                    ...
                    <div class="mt-1 flex items-center gap-x-2">
                        @php
                            ...
                            if ($order->payment_status == 'pending') {
                                $payment_status =
                                    '<span class="bg-blue-500 py-1 px-3 rounded text-white shadow">Ditunda</span>';
                            ...
                            if ($order->status == 'new') {
                                ...
                                $status =
                                    '<span class="bg-orange-500 py-1 px-3 rounded text-white shadow">Diproses</span>';
                            } elseif ($order->status == 'shipped') {
                                $status =
                                    '<span class="bg-green-500 py-1 px-3 rounded text-white shadow">sedang dikirim</span>';
                            } elseif ($order->status == 'delivered') {
                                $status =
                                    '<span class="bg-green-700 py-1 px-3 rounded text-white shadow">Tiba Ditujuan</span>';
    ...
    <div class="flex flex-col md:flex-row gap-4 mt-4">
        ...
        <div class="md:w-1/4">
            <div class="bg-white rounded-lg shadow-md p-6">
                <h2 class="text-lg font-semibold mb-4">Ringakasan</h2>
